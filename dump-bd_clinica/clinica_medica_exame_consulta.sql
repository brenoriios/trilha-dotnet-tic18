...
CREATE TABLE `exame_consulta` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_exame_idx` (`id_exame`),
  KEY `fk_consulta_idx` (`id_consulta`),
  CONSTRAINT `fk_consulta` FOREIGN KEY (`id_consulta`) REFERENCES `consulta` (`numero`),
  CONSTRAINT `fk_exame` FOREIGN KEY (`id_exame`) REFERENCES `exame` (`id`)
...
LOCK TABLES `exame_consulta` WRITE;
/*!40000 ALTER TABLE `exame_consulta` DISABLE KEYS */;
/*!40000 ALTER TABLE `exame_consulta` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-12-19 17:02:23
